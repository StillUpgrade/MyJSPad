...
PlayState.prototype.update = function(game, dt) {
    ...
    if(game.pressedKeys[65] || game.pressedKeys[68] || game.pressedKeys[68] || game.pressedKeys[87] || game.pressedKeys[83] || game.pressedKeys[82] || game.pressedKeys[81]) {
        this.fireRocket();
    }
...
PlayState.prototype.draw = function(game, dt, ctx) {
    ...
    for(var i=0; i<this.invaders.length; i++) {
        var invader = this.invaders[i];
        var img=document.getElementById("datmonster");
